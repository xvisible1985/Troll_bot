...
const SETTING_LABELS = {
  ...
  mood_drink_friend_delta: 'Бухалово: +настроение при "подружились"',
  attitude_drink_friend_delta: 'Бухалово: +отношение при "подружились"',
...
const SETTING_RANGES = {
  ...
  mood_drink_friend_delta: [0, 50, 5],
  attitude_drink_friend_delta: [0, 50, 5],
